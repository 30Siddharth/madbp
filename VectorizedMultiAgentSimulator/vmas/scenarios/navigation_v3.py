...
class Scenario(BaseScenario):
    def make_world(self, batch_dim: int, device: torch.device, **kwargs):
        ...
        self.floor_width=kwargs.pop("width", 2)
        self.floor_length = kwargs.pop("length", 1)
    ...
    def reset_world_at(self, env_index: int = None):
        ...
        for _ in self.world.agents:
            position = ScenarioUtils.find_random_pos_for_entity(
                ...
                x_bounds=(-1.5*self.world_semidim, -0.0*self.world_semidim),
                y_bounds=(-1.5*self.world_semidim, -0.0*self.world_semidim),
            )
