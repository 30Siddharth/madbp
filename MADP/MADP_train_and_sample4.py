...
from MADP5 import MultiAgentDiffusionPolicy
...
class ChunkedTrajectoryDataset(Dataset):
    def __init__(self, h5_path, chunk_size=10, num_samples=None, split='train', train_ratio=0.8):
...
if __name__=='__main__':
    ...
    train_dataset = ChunkedTrajectoryDataset(h5_path=h5_path, chunk_size=10, split='train')
    test_dataset = ChunkedTrajectoryDataset(h5_path=h5_path, chunk_size=10, split='test')
    ...
    horizon=10,                         # Set to match your trajectory length
    hidden_dim=64,
