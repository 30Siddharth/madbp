...
from MADP_Transformer import MultiAgentDiffusionPolicy
...
def train_diffusion_model(model, dataloader, test_dataloader=None, optimizer=None, 
    ...
    for epoch in range(num_epochs):
        ...
        writer.add_scalar('Loss/Constrained_action/MADP3/epoch', avg_train_loss, epoch)
...
class TrajectoryDataset(Dataset):
    def __init__(self, h5_path, num_samples=None, split='train', train_ratio=0.8, horizon=10):
    ...
    def __getitem__(self, idx):
        ...
        states_actions = states_actions[:, :horizon]
        # start_poses = start_poses[:, :horizon]
        # goal_poses = goal_poses[:, :horizon]
        # num_agents
...
if __name__=='__main__':
    ...
    train_dataset = TrajectoryDataset(h5_path=h5_path, split='train', horizon=5)
    test_dataset = TrajectoryDataset(h5_path=h5_path, split='test', horizon=5)
    ...
    model = MultiAgentDiffusionPolicy(
        ...
        horizon=5,  # Set to match your trajectory length
        hidden_dim=64,
