...
class ChunkedTrajectoryDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Extract the chunk
        states_actions = full_trajectory[start_idx:end_idx, :, :2]  # Get only states
        # states_actions_ = full_trajectory[start_idx:end_idx]
        ...
        start_pose_context = states_actions[0, :, :2]  # First timestep, position and velocity
