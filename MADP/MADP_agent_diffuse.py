...
from Traj_UNet_Simplified import TrajectoryUNet
...
class MultiAgentDiffusionPolicy(nn.Module):
    ...
    def get_time_embedding(self, timesteps, hidden_dim):  # Embedding of the diffusion time step
        """
    ...
    def forward_diffusion_per_agent(self, x_start, t, noise=None):
        """
    ...
    def p_losses(self, x_start, context, t, active_agents=None, noise=None, loss_type="cw"):
        ...
        x_noisy, noise = self.forward_diffusion_per_agent(x_start, t, noise)
...
# Example usage for curriculum learning
...
# Example of how to use the curriculum learning during inference
